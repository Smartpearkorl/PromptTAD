...
if cfg.basic.use_ins:
    ...
    # instance decoder --> directly mean for obejct tokens and reducer for object-aug image embs
    cfg.ins_decoder = 'mean' 
...
if cfg.basic.selected_ano_decoder == 'plain':
    ...
    cfg.ano_decoder.reducer.has_obj_embs = False
    # # MLP for object embedding to latent
    # if cfg.basic.use_ins:
    #     cfg.ano_decoder.reducer.mlp_dim = IL(lambda c: 1*c.basic.hid_dim)
    #     cfg.ano_decoder.reducer.mlp_depth = 2

    cfg.ano_decoder.reducer.dim_scale = 2
