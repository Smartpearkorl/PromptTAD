...
import sys
from runner import DADA_FOLDER
cfg = Config()
...
from runner.src.dota import DADA


input_shape = [480, 640]
cfg.dataset.type = DADA
cfg.dataset.name = 'data'
cfg.dataset.root_path = str(DADA_FOLDER)
cfg.dataset.phase = 'train'
cfg.dataset.pre_process_type = 'rgb' # rgb 
