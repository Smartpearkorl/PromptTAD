...
datacfg_path = './configs/base/dada_movad_rgb_cfg.py'
modelcfg_path = './configs/model/poma/vst/instance_detection/vst_ins_fpn(1)_prompt(1)_rnn.py'
...
cfg.unfreeze()
# update VCL
cfg.datacfg.train_dataset.cfg.VCL = 32
