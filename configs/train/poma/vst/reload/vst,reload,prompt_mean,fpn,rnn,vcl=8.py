...
modelcfg_path = '/home/qh/TDD/pama/configs/model/poma/vst/vst_fpn_prompt_mean_rnn.py'
...
# update some data
cfg.basecfg.basic.model_type = 'poma_prompt_mean_fpn_rnn'
...
cfg.basecfg.basic.directly_load = "/data/qh/DoTA/poma_v2/rnn/prompt_mean,rnn,vcl=8,lr=0.002,depth=4/checkpoints/model-140.pt"
