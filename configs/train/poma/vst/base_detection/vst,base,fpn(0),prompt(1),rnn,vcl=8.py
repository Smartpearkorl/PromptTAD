...
modelcfg_path = './configs/model/poma/vst/base_detection/vst_base_fpn(0)_prompt(1)_rnn.py'
...
# update some data
# cfg.basecfg.basic.model_type = 'poma_prompt_rnn_no'
cfg.basecfg.basic.model_type = 'poma_base,fpn(0),prompt(1)'
