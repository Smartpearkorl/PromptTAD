...
modelcfg_path = './configs/model/poma/vst/base_detection/vst_base_fpn(1)_prompt(0)_rnn.py'
...
cfg.unfreeze()
# update some data
# cfg.basecfg.basic.model_type = 'poma_base_fpn_rnn'
cfg.basecfg.basic.model_type = 'poma_base,fpn(1),prompt(0)'
