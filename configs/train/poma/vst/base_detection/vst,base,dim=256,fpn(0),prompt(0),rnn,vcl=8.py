...
modelcfg_path = './configs/model/poma/vst/base_detection/vst(dim=256)_base_fpn(0)_prompt(0)_rnn.py'
...
cfg.unfreeze()
# update some data
# cfg.basecfg.basic.model_type = 'poma_base_no_fpn_rnn_256'
cfg.basecfg.basic.model_type = 'poma_base,dim=256,fpn(0),prompt(0)'
