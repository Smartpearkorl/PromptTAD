...
modelcfg_path = '/home/qh/TDD/pama/configs/model/poma/vst/instance_detection/vst_ins_bottle_prompt_rnn.py'
...
# update some data
cfg.basecfg.basic.model_type = 'poma_bottle_prompt_fpn_rnn'
