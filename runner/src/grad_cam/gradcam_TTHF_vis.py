...
from models.TTHF.tadclip import *
...
class vis_grad_cam():
    ...
    def load_model(self, args, ckp_path):
        print("=> loading model")
...
if __name__ == '__main__':
    ...
    "/data/qh/DoTA/output/Prompt/box_obj_loss_weight=0.0002_0.02/"
    ...
    对比两个模型在每个场景上AUC
    '''
    # folder_1 = "/data/qh/DoTA/poma_v2/rnn/load,base,fpn,rnn,vcl=8,lr=0.002/"
    # epoch_1 = 200
    # folder_2 = "/data/qh/DoTA/poma_v2/rnn/load,prompt,rnn,vcl=8,lr=0.002,depth=4/"
    # epoch_2 =  60
    ''' v1 '''
    # folder_1 = "/data/qh/DoTA/poma_v2/rnn/base,no_fpn,rnn,vcl=8,lr=0.002/"
    # epoch_1 = 160
    # folder_2 = "/data/qh/DoTA/poma_v2/instance/vst,ins,prompt,rnn,depth=4/"
    # epoch_2 =  160
    ''' v2 '''
    folder_1 = "/data/qh/DoTA/poma_v2/rnn/base,no_fpn,rnn,vcl=8,lr=0.002/"
    epoch_1 = 160
    folder_2 = "/data/qh/DoTA/poma_v2/instance/[v2]vst,ins,prompt,rnn,depth=4/"
    epoch_2 =  120
    # # 对比两个模型在每个scene的AUC
